...
lgb_model.fit(X_train_baseline, y_train_baseline)
y_pred_baseline = lgb_model.predict(X_test_baseline)
...
print(f'Accuracy of Baseline Model: {accuracy_baseline * 100:.2f}%')
